...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and()
            ...
            .antMatchers("/actuator/**", "/v3/api-docs/**", "/swagger-ui/**", "/javainuse-openapi/**",
            ...
            .antMatchers(HttpMethod.DELETE).hasAuthority("SCOPE_starter-api:delete")
            ...
            .antMatchers(HttpMethod.POST).hasAuthority("SCOPE_starter-api:post")
            .antMatchers(HttpMethod.PUT).hasAuthority("SCOPE_starter-api:put")
